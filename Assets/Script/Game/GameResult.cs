...
public class GameResult : MonoBehaviour
{
    ...
    public void on_result(byte win, SendFn send)
    {
        ...
        win_text.text = (DataManager.instance.b_win_count + DataManager.instance.w_win_count) + "È¸";
        lose_text.text = (DataManager.instance.b_lose_count + DataManager.instance.w_lose_count) + "È¸";
        tie_text.text = (DataManager.instance.b_tie_count + DataManager.instance.w_tie_count) + "È¸";
