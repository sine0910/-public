...
public class GameSoundSetting : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        background = transform.Find("GameCanvas/SoundSettingPage/Main/Background/Image").GetComponent<Image>();
        effect = transform.Find("GameCanvas/SoundSettingPage/Main/Effect/Image").GetComponent<Image>();

        background_text = transform.Find("GameCanvas/SoundSettingPage/Main/Background/Button/Text").GetComponent<Text>();
        effect_text = transform.Find("GameCanvas/SoundSettingPage/Main/Effect/Button/Text").GetComponent<Text>();

        transform.Find("GameCanvas/SoundSettingPage/Main/Background/Button").GetComponent<Button>().onClick.AddListener(on_click_background);
        transform.Find("GameCanvas/SoundSettingPage/Main/Effect/Button").GetComponent<Button>().onClick.AddListener(on_click_effect);

        transform.Find("GameCanvas/SoundSettingPage/Main/CloseButton").GetComponent<Button>().onClick.AddListener(close_sound_setting);
    }
    ...
    void on_click_background()
    {
        ...
        GameSoundManager.instance.mute_background(!DataManager.instance.background_sound);
    ...
    void on_click_effect()
    {
        ...
        GameSoundManager.instance.mute_effect(!DataManager.instance.effect_sound);
        DataManager.instance.save_sound_data();
    }
}
